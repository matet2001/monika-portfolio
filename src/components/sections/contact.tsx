...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="w-full px-6 md:px-10 scroll-mt-[var(--header-height)] bg-gradient-primary text-foreground h-screen flex justify-center items-center"
    >
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center justify-between">
          ...
          >
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground">
              Ha kérdésed van, vagy szeretnél jelentkezni családállításra,
              bátran vedd fel velem a kapcsolatot az alábbi elérhetőségeken!
            </p>

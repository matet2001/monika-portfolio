...
export default function ConstellationSection() {
  return (
    <section id="csaladallitas" className="w-full ">
      ...
      <div className="w-full px-4 sm:px-6 md:px-10 bg-gradient-secondary text-foreground py-10 md:py-16 -scroll-mt-56">
        <div className="max-w-[1400px] mx-auto flex flex-col space-y-16 2xl:space-y-24">
          <h1 className="text-4xl sm:text-5xl 2xl:text-6xl font-bold text-primary text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
            ...
            >
              <h2 className="text-3xl sm:text-4xl 2xl:text-5xl font-bold text-primary leading-tight">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative w-full md:w-1/2 h-96 sm:h-[420px] md:h-[460px] lg:h-[480px] 2xl:h-[600px] rounded-xl overflow-hidden shadow-2xl"
            >
              <Image
      ...
      <div className="w-full px-4 sm:px-6 md:px-10 bg-background text-foreground py-12 md:py-16 2xl:py-24">
        <div className="max-w-[1000px] mx-auto">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-center px-4 sm:px-6">
              <p className="text-base sm:text-lg 2xl:text-xl leading-relaxed">
              ...
              <div className="bg-primary/5 border-l-4 border-primary p-5 sm:p-6 rounded-r-lg mt-6">
                <p className="text-foreground italic text-lg sm:text-xl 2xl:text-2xl leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-6 sm:gap-10 md:gap-12 max-w-2xl mx-auto pt-8">
              ...
              >
                <div className="bg-primary/10 p-4 rounded-2xl">
                  <HeartCrack className="w-9 h-9 sm:w-10 sm:h-10 2xl:w-12 2xl:h-12 text-primary" />
                </div>
              ...
              >
                <div className="bg-primary/10 p-4 rounded-2xl">
                  <Leaf className="w-9 h-9 sm:w-10 sm:h-10 2xl:w-12 2xl:h-12 text-primary" />
                </div>
                <p className="font-semibold text-base sm:text-lg text-center">
                  Rálátás
                </p>
              ...
              >
                <div className="bg-primary/10 p-4 rounded-2xl">
                  <HelpingHand className="w-9 h-9 sm:w-10 sm:h-10 2xl:w-12 2xl:h-12 text-primary" />
                </div>
                <p className="font-semibold text-base sm:text-lg text-center">
                  Felszabadulás
                </p>
      ...
      <div className="w-full px-4 sm:px-6 md:px-10 bg-gradient-secondary text-foreground py-12 md:py-16 2xl:py-24">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
              viewport={{ once: true }}
              className="relative w-full md:w-1/2 h-96 sm:h-[450px] md:h-[500px] lg:h-[560px] 2xl:h-[660px] rounded-xl overflow-hidden shadow-2xl"
            >
              <Image
